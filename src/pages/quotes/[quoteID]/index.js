            ...
            <div className="flex flex-1 flex-col items-center justify-center relative">
              <div className="flex flex-1 flex-col pb-18 max-w-md md:max-w-2xl ">
                <section className="w-full mx-auto  mt-10 md:mt-10 px-5 pb-10">
                  ...
                  <a href="#" className="m-1 flex flex-wrap items-center text-xs  md:text-xs text-slate-500 border border-gray-300 py-1 px-2 rounded-md bg-gray-200 capitalize ">action</a>
                  <a href="#" className="m-1 flex flex-wrap items-center text-xs  md:text-xs text-slate-500 border border-gray-300 py-1 px-2 rounded-md bg-gray-200 capitalize ">adventure</a>
                  </div>
                  </div>
