...
export default function Header() {
  ...
  return (
    <>
     <header class="fixed z-50 w-full px-4 py-1.5 items-center transition duration-300 ease-out bg-opacity-10 backdrop-filter backdrop-blur">
    <div class="flex items-center justify-between mx-auto max-w-7xl">
        <div class="flex items-center">
            <a href="https://nowandme.com">
            ...
            <a href="/careers" target="_blank" class="px-3 py-1 ml-2.5 text-sm font-medium text-green-500 bg-green-100 rounded-md hidden sm:inline">We are hiring</a>
        </div>
        <div class="flex space-x-3 md:space-x-6 font-bold text-gray-900 items-center">
            <a href="/" class="hidden md:block">Home</a>
            <div class="cursor-pointer relative group hidden md:block">
                <span class="flex items-center">
                    Talk to someone
                    <span class="ml-2 text-black rotate-90">›</span>
                </span>
                <div class="absolute hidden group-hover:block bg-white border-[1px] p-4 w-full pt-4 rounded-md shadow-sm">
                    <a href="/experts" class="text-black hidden md:block hover:text-[#FF6D42]">Experts</a><a href="/home" class="text-black hidden md:block mt-4 hover:text-[#FF6D42]">Community</a>
                </div>
            </div>
            <div class="cursor-pointer relative group hidden md:block">
                <span class="flex items-center">
                ...
                <div class="absolute hidden group-hover:flex group-hover:flex-col group-hover:gap-3 bg-white border-[1px] p-4 w-max pt-4 -ml-10 rounded-md shadow-sm">
                    <a class="text-black hidden md:block hover:text-[#FF6D42]" href="/guides/anxiety">Anxiety Therapy</a><a class="text-black hidden md:block hover:text-[#FF6D42]" href="/guides/depression">Depression Counseling</a>
                </div>
            </div>
            <a href="/blog" class="hidden md:block">Blog</a><a href="https://shop.nowandme.com" target="_blank" class="hidden md:block">Shop</a>
            <a
                href="https://nowandme.sng.link/Dqsa0/4x5h?pcn=header-download-btn&amp;_smtype=3"
                class="px-5 hidden sm:block bg-x-orange-500 text-white text-sm font-bold rounded-full focus:outline-none focus:ring-3 focus:ring-x-orange-100 relative overflow-hidden py-3"
                target="_blank"
                rel="noreferrer"
            >
                Download now
            ...
            <section class="MOBILE-MENU flex md:hidden justify-start items-between">
                <div class="HAMBURGER-ICON space-y-2 w-fit md:justify-start">
                ...
                <div class="hidden bg-black w-full h-[100vh] z-10 fixed top-0 left-0 text-white text-4xl font-bold flex flex-1 flex-col justify-between">
                    <div class="absolute top-0 right-0 px-3 py-5 cursor-pointer">
                        <svg class="h-6 w-8 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <ul class="flex mt-20 p-6 flex-col items-left gap-7 justify-between min-h-[250px]">
                        ...
                        <li>
                            <div>
                                <div>Guides<span class="ml-4 text-white absolute rotate-90">›</span></div>
                            </div>
                        </li>
                        <li><a href="/blog">Blog</a></li>
                        <li><a href="https://shop.nowandme.com" target="_blank">Shop</a></li>
                    </ul>
                </div>
            </section>
        </div>
